...
export function SignUpForm() {
  return (
    <div class="pt-72 flex items-center justify-center py-6 mb-10">
      <div
      ...
      >
        ...
        <h1 class="text-white text-2xl font-semibold">Sign Up</h1>
        ...
        <div class="w-full flex gap-2 flex-col text-white text-sm font-light">
          ...
          />
          <label class="mt-1" htmlFor="Confirm Password">
            Confirm Password
          </label>
          <input
            class="bg-white text-black h-9 rounded-md px-3 text-sm"
          ...
          <p class="text-xs text-center">
            ...
            <a class="text-primary cursor-pointer" href="/login">
              Login Now!
            </a>
          </p>
        </div>
