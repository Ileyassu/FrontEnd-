...
export function SignUpForm(){
    return (
        <div class="pt-65 flex items-center justify-center py-9 mb-10">
            <div class="flex flex-col gap-10 items-center justify-center relative w-full max-w-md py-12 px-20 rounded-4xl "
                ...
                <h1 class="text-white text-3xl font-semibold">Sign Up</h1>
                ...
                <div class=" w-full flex gap-2 flex-col text-white text-[14px] font-light">
                    ...
                    <label class="mt-2" htmlFor="Confirm Password">Confirm Password</label>
                    <input class="bg-white text-black h-9 rounded-md px-3" type="Password" id="Confirm Password"  placeholder="Confirm Password" />
                    <a href="forgotPassword text-[10px]">Forgot Password</a>
                    <SignUpBtn text="Sign up" signup={true} />
                    ...
                    <p>Already have an account yet? <a class="text-primary cursor-pointer" href="/login">Login Now!</a></p>
                </div>
            </div>
        </div>
    ) as HTMLElement;
